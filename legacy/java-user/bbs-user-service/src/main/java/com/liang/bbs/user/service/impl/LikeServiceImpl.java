...
//      */
//     @Override
//     public LikeDTO getByArticleIdUserId(Integer articleId, Integer userid) {
//         LikePoExample example = new LikePoExample();
...
//      */
//     @Override
//     public Boolean isLike(Integer articleId, Integer userid) {
//         LikePoExample example = new LikePoExample();
//         example.createCriteria().andStateEqualTo(true)
...
//     @Override
//     public Long getUserTheLikeCount(Integer userid) {
//         LikePoExample example = new LikePoExample();
//         example.createCriteria().andStateEqualTo(true)
//                 .andLikeUserEqualTo(userId);
//         List<LikePo> likePos = likePoMapper.selectByExample(example);
