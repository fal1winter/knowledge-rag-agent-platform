...
//      */
//     @Override
//     public Boolean update(Integer userid, Integer points) {
...
//         // 所有的用户id
//         List<Integer> userIds = userService.getAllList().stream().map(UserListDTO::getId).collect(Collectors.toList());
//         // 用户的文章阅读数量
...
//         List<Integer> userIds = userLevelDTOS.stream().map(UserLevelDTO::getUserId).collect(Collectors.toList());
//         // 用户基础信息
...
//      */
//     @Override
//     public List<UserLevelDTO> getByUserId(Integer userid) {
//         UserLevelPoExample example = new UserLevelPoExample();
...
//      */
//     @Override
//     public List<UserLevelDTO> getByUserIds(List<Integer> userIds) {
//         UserLevelPoExample example = new UserLevelPoExample();
...
//      */
//     @Override
//     public UserForumDTO getUserInfo(Integer userid, UserSsoDTO currentUser) {
//         UserForumDTO userForumDTO = new UserForumDTO();
//         // 通过用户id获取用户等级信息
