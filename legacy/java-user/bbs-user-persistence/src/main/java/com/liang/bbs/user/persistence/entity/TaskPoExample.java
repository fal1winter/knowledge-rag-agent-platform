...
public class TaskPoExample {
    ...
    public TaskPoExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public TaskPoExample orderBy(String ... orderByClauses) {
    ...
    public TaskPoExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public TaskPoExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public TaskPoExample distinct(boolean distinct) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private TaskPoExample example;

        protected Criteria(TaskPoExample example) {
            super();
            this.example = example;
        }

        public TaskPoExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.liang.bbs.user.persistence.entity.TaskPoExample example);
    }
}