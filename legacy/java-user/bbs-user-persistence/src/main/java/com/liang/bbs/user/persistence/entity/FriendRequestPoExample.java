...
public class FriendRequestPoExample {
    ...
    public FriendRequestPoExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public FriendRequestPoExample orderBy(String ... orderByClauses) {
    ...
    public FriendRequestPoExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public FriendRequestPoExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public FriendRequestPoExample distinct(boolean distinct) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private FriendRequestPoExample example;

        protected Criteria(FriendRequestPoExample example) {
            super();
            this.example = example;
        }

        public FriendRequestPoExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.liang.bbs.user.persistence.entity.FriendRequestPoExample example);
    }
}