...
public class SysUserInstitutionPoExample {
    ...
    public SysUserInstitutionPoExample() {
    ...
    public SysUserInstitutionPoExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public SysUserInstitutionPoExample orderBy(String ... orderByClauses) {
    ...
    public SysUserInstitutionPoExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public SysUserInstitutionPoExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public SysUserInstitutionPoExample distinct(boolean distinct) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private SysUserInstitutionPoExample example;

        protected Criteria(SysUserInstitutionPoExample example) {
            super();
            this.example = example;
        }

        public SysUserInstitutionPoExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.liang.bbs.user.persistence.entity.SysUserInstitutionPoExample example);
    }
}