...
public class FollowPoExample {
    ...
    public FollowPoExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public FollowPoExample orderBy(String ... orderByClauses) {
    ...
    public FollowPoExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public FollowPoExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public FollowPoExample distinct(boolean distinct) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private FollowPoExample example;

        protected Criteria(FollowPoExample example) {
            super();
            this.example = example;
        }

        public FollowPoExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.liang.bbs.user.persistence.entity.FollowPoExample example);
    }
}