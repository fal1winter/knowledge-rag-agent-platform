...
public class SysRolePermissionPoExample {
    ...
    public SysRolePermissionPoExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public SysRolePermissionPoExample orderBy(String ... orderByClauses) {
    ...
    public SysRolePermissionPoExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public SysRolePermissionPoExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public SysRolePermissionPoExample distinct(boolean distinct) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private SysRolePermissionPoExample example;

        protected Criteria(SysRolePermissionPoExample example) {
            super();
            this.example = example;
        }

        public SysRolePermissionPoExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.liang.bbs.user.persistence.entity.SysRolePermissionPoExample example);
    }
}