...
public class FriendPoExample {
    ...
    public FriendPoExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public FriendPoExample orderBy(String ... orderByClauses) {
    ...
    public FriendPoExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public FriendPoExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public FriendPoExample distinct(boolean distinct) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private FriendPoExample example;

        protected Criteria(FriendPoExample example) {
            super();
            this.example = example;
        }

        public FriendPoExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.liang.bbs.user.persistence.entity.FriendPoExample example);
    }
}