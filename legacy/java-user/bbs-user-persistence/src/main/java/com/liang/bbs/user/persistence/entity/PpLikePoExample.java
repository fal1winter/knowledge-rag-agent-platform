...
public class PpLikePoExample {
    ...
    public PpLikePoExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public PpLikePoExample orderBy(String ... orderByClauses) {
    ...
    public PpLikePoExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public PpLikePoExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public PpLikePoExample distinct(boolean distinct) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private PpLikePoExample example;

        protected Criteria(PpLikePoExample example) {
            super();
            this.example = example;
        }

        public PpLikePoExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.liang.bbs.user.persistence.entity.PpLikePoExample example);
    }
}