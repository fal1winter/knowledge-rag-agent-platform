...
public class ChatroomRelationPoExample {
    ...
    public ChatroomRelationPoExample() {
    ...
    public ChatroomRelationPoExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public ChatroomRelationPoExample orderBy(String ... orderByClauses) {
    ...
    public ChatroomRelationPoExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public ChatroomRelationPoExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public ChatroomRelationPoExample distinct(boolean distinct) {
    ...
    public static class Criteria extends GeneratedCriteria {
        private ChatroomRelationPoExample example;

        protected Criteria(ChatroomRelationPoExample example) {
            super();
            this.example = example;
        }

        public ChatroomRelationPoExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.liang.bbs.user.persistence.entity.ChatroomRelationPoExample example);
    }
}